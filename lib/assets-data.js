...
2022 yılında FTX çöküşü, Solana ekosistemini etkilese de, network teknik olarak güçlü ve geliştirmeye devam etmektedir.`,
  ...
  'bist-100': {
    ...
    slug: 'bist-100',
    category: 'Borsa',
    description: 'BIST 100, Borsa İstanbul\'da işlem gören en likit ve değerli 100 şirketin hissesinden oluşan temel endekstir. Türkiye ekonomisinin durumunu gösteren önemli bir barometredir.',
    longDescription: `BIST 100, Borsa İstanbul\'un en önemli endeksidir. Türkiye ekonomisinde faaliyet gösteren en büyük ve en likit şirketleri içermektedir.

BIST 100 endeksinde yer alan şirketler, finansal, enerji, endüstri ve hizmetler sektörlerinden gelmektedir. Bu şirketlerin hisse performansı, Türkiye ekonomisinin durumunu yansıtmaktadır.

BIST 100 yatırımı, Borsa İstanbul'daki hisse senetlerine veya endeks fonlarına yatırım yaparak mümkün olmaktadır. Endeks fonları, çeşitlendirilmiş yatırım sunmaktadır.

BIST 100 endeksinin hareketleri, makroekonomik veriler, merkez bankası kararları, küresel gelişmeler ve siyasi belirsizlikler tarafından etkilenmektedir.

Uzun vadeli yatırım hedefine sahip yatırımcılar, BIST 100 endeks fonlarına yatırım yapabilir. Ancak kısa vadeli volatilite yüksek olabilmektedir.`,
    apiEndpoint: '/api/markets/bist',
    dataKey: 'xu100',
    relatedAssets: ['bist-50', 'bist-30', 'usd-try'],
    keywords: ['BIST 100', 'borsa', 'hisse senedi', 'endeks', 'yatırım'],
  },
};
